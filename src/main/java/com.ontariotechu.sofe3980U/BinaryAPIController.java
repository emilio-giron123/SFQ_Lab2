...
public class BinaryAPIController {
	...
	//OR operation
	@GetMapping("/or")
	public String orOperation(@RequestParam(name="operand1") String operand1,
	...
	//AND operation
	@GetMapping("/and")
	public String andOperation(@RequestParam(name="operand1") String operand1,
							   @RequestParam(name="operand2") String operand2) {
		Binary number1 = new Binary(operand1);
		Binary number2 = new Binary(operand2);
	...
	//MULTIPLY operation
	@GetMapping("/multiply")
	public String multiplyOperation(@RequestParam(name="operand1") String operand1,
									@RequestParam(name="operand2") String operand2) {
		Binary number1 = new Binary(operand1);
		Binary number2 = new Binary(operand2);
